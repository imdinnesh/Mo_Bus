...
func BookingRoutes(router *gin.RouterGroup, db *gorm.DB) {
	...
	bookingRouter.POST("/create-booking", func(ctx *gin.Context) {
	...
	bookingRouter.GET("/get-bookings", func(ctx *gin.Context) {
		userID := ctx.GetUint("userId")
	...
	bookingRouter.GET("/get-booking/:id", func(ctx *gin.Context) {
		userId := ctx.GetUint("userId")
